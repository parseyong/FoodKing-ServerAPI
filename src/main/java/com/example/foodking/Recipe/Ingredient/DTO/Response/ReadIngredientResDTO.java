package com.example.foodking.Recipe.Ingredient.DTO.Response;
...
public class ReadIngredientResDTO {

    private String ingredientName;

    private String ingredientAmount;

    public static ReadIngredientResDTO toDTO(Ingredient ingredient){
        return ReadIngredientResDTO.builder()
